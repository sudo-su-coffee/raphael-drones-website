...
import { ArrowLeft, ArrowUpRight, ChevronDown, Filter, Instagram, Linkedin, MapPin } from "lucide-react";
...
type Entry = {
  year: string;
  category: "Milestone" | "Training" | "Field work";
  title: string;
  summary: string;
  detail: string;
};
...
const entries: Entry[] = [
  { year: "2026", category: "Milestone", title: "Vayal Vimaani application demo launch", summary: "A farmer-first drone service idea brought into the public conversation.", detail: "The Vayal Vimaani application was introduced during a Raphael Drones and GIS Services milestone event, connecting agricultural drone work with practical support for farmers." },
  { year: "2026", category: "Training", title: "RVCE Sivakasi seminar and collaboration", summary: "A shared space for drone technology, GIS, skill development, and innovation.", detail: "Raphael Drones participated in an RVCE Sivakasi seminar and collaboration milestone focused on building useful knowledge around drone technology and precision agriculture." },
  { year: "2024", category: "Milestone", title: "Raphael Drones begins", summary: "Founded in Tamil Nadu with a practical view of aerial technology.", detail: "Raphael Drones and GIS Services began from Rajapalayam, bringing together drone solutions, GIS services, precision agriculture, and hands-on training." },
  { year: "Ongoing", category: "Field work", title: "From field capture to useful direction", summary: "A growing archive of agricultural, GIS, LiDAR, and learning work.", detail: "This archive is designed for the team to keep adding verified work, training moments, product demonstrations, and community milestones over time." },
];
  ...
  return (
    <div className="archive-page">
      <header className="archive-header">
        <div className="archive-topline"><span>Raphael Drones & GIS Services</span><span>Rajapalayam · Tamil Nadu · India</span></div>
